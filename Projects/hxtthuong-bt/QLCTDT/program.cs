...
namespace QLCTDT
{
    ...
    struct MonHoc
    {
        public string ma; // ma hoc phan
        public string tenMH; // ten mon hoc
        public int tinchi; // so tin chi
        public List<string> monhocTQ; // danh sach ma mon hoc tien quyet
        public LoaiMonHoc loaiMH; // loai mon hoc
        public int hocky; // hoc ky du kien
    }
    enum LoaiMonHoc { TuChon, BatBuoc }; // kieu liet ke the hien hai loai mon hoc
    ...
    class Program
    {
        ...
        static void InMenu()
        {
            ...
            Console.WriteLine("4 - Danh sach mon hoc theo ten mon hoc");
            Console.WriteLine("5 - Xem thong tin mon hoc");
            Console.WriteLine("6 - Xem danh sach mon hoc co the dang ky trong hoc ky");
            Console.WriteLine("7 - Xem thong tin chuong trinh dao tao");
            ...
            while (true)
            {
                ...
                switch (menu)
                {
                    ...
                    case 3: // Xoa mon hoc
                        XoaMH();
                        break;
                    case 4: // in danh sach mon hoc theo ten mon hoc
                        InTheoTenMH();
                        break;
                    case 5: // In thong tin mon hoc
                        InThongTinMh();
                        break;
                    case 6: // in danh sach mon hoc co the dang ky trong hoc ky
                        InMHtrongHK();
                        break;
                    case 7: // In thong tin chuong trinh dao tao
                        ThongTinCTDT();
                        break;
                    case 8: // doc file
                        DocFile();
